...
Route::post('carts/shop-now', [\App\Http\Controllers\Frontend\CartController::class, 'shopNow'])->name('carts.shopNow');

Route::get('/contact', [\App\Http\Controllers\Frontend\ContactController::class, 'index'])->name('contact.index');
Route::post('/contact/submit', [\App\Http\Controllers\Frontend\ContactController::class, 'submit'])->name('contact.submit');
Route::get('/about_us', [\App\Http\Controllers\Frontend\AboutUsController::class, 'index'])->name('about_us.index');
...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::get('orders/{orderId}', [\App\Http\Controllers\Frontend\OrderController::class, 'show'])->name('frontend.orders.show');
    Route::post('/orders/mark-as-received/{id}', [\App\Http\Controllers\Frontend\OrderController::class, 'markAsReceived'])->name('orders.markAsReceived');
    Route::put('orders/cancel/{order}', [\App\Http\Controllers\Frontend\OrderController::class, 'doCancel'])->name('frontend.orders.cancel');
