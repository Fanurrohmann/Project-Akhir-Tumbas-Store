	...
	<div class="breadcrumb-area pt-100 breadcrumb-padding pb-100" style="background-image: url({{ asset('themes/TumbasStore/assets/img/bg/breadcrumb3.jpg') }})">
		<div class="container">
			<div class="breadcrumb-content text-center">
				<h2>Halaman Keranjang Belanja</h2>
				<ul>
		...
		<div class="container">
			...
			<div class="row mt-3">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h1 class="cart-heading fw-bold">Keranjang</h1>
					<form action="">
						<div class="table-content table-responsive shadow">
							<table>
								<thead>
									<tr>
										<th><b>Hapus</b></th>
									...
									@forelse ($items as $item)
										...
										<tr>
											<td class="product-remove">
												<a href="{{ url('carts/remove/'. $item->rowId)}}" class="delete"><i class="pe-7s-close" style="color: red;"></i></a>
											</td>
						...
						<div class="row">
							<div class="col-md-5 ml-auto">
								<div class="cart-page-total">
									...
									<a href="{{ url('orders/checkout') }}" class="btn px-5 py-4 rounded-pill d-flex align-items-center justify-content-center w-50 mb-3">
