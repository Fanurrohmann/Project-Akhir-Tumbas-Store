...
@section('content')
	<div class="breadcrumb-area pt-100 breadcrumb-padding pb-100" style="background-image: url({{ asset('themes/TumbasStore/assets/img/bg/bg3.svg') }})">
							...
							<div class="shop-bar pb-60">
								<div class="shop-found-selector">
									<div class="shop-found">
										<p><span>{{ count($products) }}</span> Produk Dari <span>{{ $products->total() }}</span></p>
									</div>
                                                ...
                                                <div class="product-wrapper mb-30">
                                                    <div class="product-img">
                                                        <a href="{{ url('product/'. $product->slug) }}">
                                                            ...
                                                            @else
                                                                <img src="{{ asset('themes/TumbasStore/assets/img/product/fashion-colorful/1.jpg') }}" alt="{{ $product->name }}">
                                                            @endif
                                                        </a>
                                                        <span>hot</span>
