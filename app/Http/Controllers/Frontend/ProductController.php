...
class ProductController extends Controller
{
    ...
    public function show(Product $product)
    {
        ...
        if (!$product->configurable()) {
            return view('frontend.products.show', compact('product', 'categories', 'imageUrl'));
        }
        ...
        $categories = Category::all();
        $imageUrl = $product->image_url ?? 'default-image-url.jpg'; // Pastikan ada fallback atau validasi
        return view('frontend.products.show', compact('product', 'categories', 'sizes', 'colors', 'imageUrl'));
